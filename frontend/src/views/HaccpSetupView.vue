...
const { currentStep, totalSteps, wizardData, haccpTrinn, canProceed, nextStep, prevStep, buildRequest, reset } = useWizardState()
  ...
  <AppLayout active-menu-item="HACCP-oppsett">
    ...
    <div class="page-content">
      ...
      <div v-else-if="showIntro" class="intro-wrapper">
        ...
        <p class="intro-desc">
          Bruk veiviseren til å generere skreddersydde sjekklister basert på virksomheten din og kravene fra Mattilsynet.
          Vi stiller spørsmål om virksomhetstype, mathåndtering og risikonivå, og lager sjekklister tilpasset HACCP-trinnet ditt.
        </p>
      ...
      <div v-else-if="showCompleted" class="intro-wrapper">
        ...
        <div class="completed-tip">
          ...
          eller når menyen endres vesentlig, for å sikre at sjekklistene er oppdaterte og i tråd med gjeldende krav.
        </div>
...
.page-content { display: flex; flex: 1; flex-direction: column; align-items: center; padding: 0 1rem 2rem; }
